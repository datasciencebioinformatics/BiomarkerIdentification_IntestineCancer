...
### 1- gdc-client command line to download the samples from the PortalGdcCancer cancer database
...
### 2- bash script to process the downladed files into reads count tables
